...
import tagsManagementService, { CreateTagRequest } from '@/services/dashboard/tagsManagement/tagsManagement.service';
...
export default function AddTag({ open, onClose, onTagAdded }: AddTagProps) {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            const response = await tagsManagementService.createTag(requestData);
            
            if (response.success) {
                onTagAdded();
                handleClose();
            } else {
                setError(response.message || 'Error al crear el tag');
            }
        } catch (err) {
